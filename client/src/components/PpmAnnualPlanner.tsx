        ...
        <table className="border-collapse min-w-max w-full">
          <thead>
            <tr className="bg-muted/50">
              <th className="sticky left-0 bg-muted/80 z-10 text-left text-xs font-semibold text-muted-foreground px-3 py-2 border-b border-r border-border" style={{ minWidth: 220, width: 220 }}>
                Asset
              </th>
              {MONTHS.map((m, i) => (
                <th
          ...
          <tbody>
            {filteredAssets.map((asset, rowIdx) => {
              ...
              return (
                ...
                >
                  {/* Asset name column */}
                  <td className="sticky left-0 z-10 px-3 py-1 border-r border-border text-sm" style={{ minWidth: 220, width: 220, background: rowIdx % 2 === 0 ? "white" : undefined }}>
