...
export default function Layout({ children }: LayoutProps) {
  ...
  const allNavItems = [
    ...
    { path: "/enterprise/contractor-pool", icon: HardHat, label: "Contractor Pool", enterpriseOnly: true, requiresEnterpriseManageRole: true, defaultOn: true },
    { path: "/enterprise/reports", icon: FileText, label: "Portfolio Reports", enterpriseOnly: true, requiresEnterpriseManageRole: true, defaultOn: true },
  ...
  const navItems = allNavItems.filter(item => {
    ...
    if (item.featureKey) {
      // Admins always see the Settings page — they must never be locked out of changing settings
