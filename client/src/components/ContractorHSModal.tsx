  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div className="relative z-10 w-full sm:max-w-2xl bg-white sm:rounded-2xl shadow-2xl flex flex-col max-h-[95vh] sm:max-h-[92vh] rounded-t-2xl">
        ...
        <div className="px-4 sm:px-6 py-3 bg-blue-600 flex-shrink-0 flex items-start sm:items-center gap-3">
          <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 sm:mt-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-blue-200 flex items-center gap-1 mt-0.5 truncate">
        ...
        {/* Acceptance area */}
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex-shrink-0 space-y-3 sm:space-y-4">
          <div
