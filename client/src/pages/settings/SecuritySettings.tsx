        ...
        <div className="space-y-2">
          ...
          <div className="border rounded-lg p-3 space-y-2 max-h-48 overflow-y-auto bg-slate-50 dark:bg-slate-900/50">
            {[
              ...
              { path: "/contractor-portal-admin", label: "Contractor Portal Admin" },
              ...
              { path: "/hs-incidents", label: "H&S Incidents" },
              { path: "/fire-risk-assessment", label: "Fire Risk Assessment" },
              { path: "/fire-marshal-panel", label: "Fire Marshal Panel" },
              { path: "/audits", label: "Audits & Inspections" },
              { path: "/permit-to-work", label: "Permit to Work" },
              { path: "/compliance-certificates", label: "Compliance Register" },
              { path: "/compliance-dashboard", label: "Compliance Dashboard" },
              { path: "/ra-builder", label: "Risk Assessment Builder" },
              { path: "/template-library", label: "Template Library" },
              { path: "/ppm", label: "PPM" },
              { path: "/helpdesk", label: "Help Desk" },
              { path: "/hr", label: "HR Module" },
