    ...
    <div className="min-h-screen max-h-screen overflow-hidden bg-background p-2 sm:p-4 flex flex-col">
      ...
      <div className="max-w-6xl mx-auto space-y-2 sm:space-y-3 flex-1 flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 flex-1 max-h-80 sm:max-h-96">
          ...
          >
            <GlassCard hover className="text-center p-3 sm:p-5 lg:p-7 group h-full flex flex-col justify-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-2.5 sm:mb-3 lg:mb-5 group-hover:scale-110 transition-transform">
          ...
          >
            <GlassCard hover className="text-center p-3 sm:p-5 lg:p-7 group h-full flex flex-col justify-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 gradient-blue rounded-full flex items-center justify-center mx-auto mb-2.5 sm:mb-3 lg:mb-5 group-hover:scale-110 transition-transform">
          ...
          <GlassCard hover className="text-center p-4 sm:p-6 lg:p-8 group h-full flex flex-col justify-center" data-testid="button-staff-checkin">
            <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gradient-to-r from-green-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-2.5 sm:mb-3 lg:mb-5 group-hover:scale-110 transition-transform">
