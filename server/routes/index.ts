...
import { registerCompanyAccreditationsRoutes } from './companyAccreditations';
...
import { registerEnterpriseScheduledReportRoutes } from './enterpriseScheduledReports';
...
export async function registerSplitRoutes(
  ...
  registerCompanyAccreditationsRoutes(app);
  ...
  registerEnterpriseScheduledReportRoutes(app);
